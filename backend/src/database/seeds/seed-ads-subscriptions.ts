...
const adConfigs: AdConfig[] = [
  // ── APPROVED — no content link ─────────────────────────────────────────
  {
    ...
    contentHe:
      'הצביעו לדוד כהן! עשרים שנות ניסיון בביטחון לאומי, שירות בממשלה ומומחיות בביטחון הגבולות. הבחירה הנכונה לפריימריז 2026.',
    dailyBudget: 600,
    cpm: 28,
    impressions: 14500,
    clicks: 820,
    ...
    durationDays: 30,
    approvedDaysAgo: 11,
    districts: ['תל אביב', 'גוש דן', 'ירושלים'],
    membersOnly: false,
  },
  {
    candidateIndex: 2,
    ...
    contentHe:
      'כל הכבוד! סיימת את החידון. עכשיו הזמן לפעול — הצביעו לאמיר שמיר בפריימריז הליכוד 2026. קולך קובע!',
    dailyBudget: 120,
    cpm: 18,
    impressions: 4800,
    clicks: 310,
  ...
  },
  {
    ...
    contentHe:
      'הצביעו לרינה לוי! מובילת הסקרים בגליל ובשרון. ניסיון כשר"פ, מחויבות לפריפריה ועוצמה לאומית. הבחירה של הצפון.',
    dailyBudget: 800,
    cpm: 35,
    impressions: 62000,
    clicks: 5800,
  ...
  },
  {
    ...
    contentHe:
      'הצביעו ליוסי ברק! יוצא הנגב, לוחם צוק איתן, ומי שיחזיר את הדרום למרכז הלאומי. ביחד נבנה עתיד בטוח לדרום ישראל.',
    dailyBudget: 550,
    cpm: 27,
    impressions: 41000,
    clicks: 3200,
  ...
  // These ads promote a specific article: candidate pays per click → article_detail opens
  {
    ...
    contentHe:
      'הצביעו לרינה לוי! תוכנית כלכלית מקיפה: הפחתת יוקר המחיה, 60,000 משרות חדשות ופיתוח הפריפריה. קראו את המאמר המלא.',
    dailyBudget: 400,
    cpm: 22,
    impressions: 9200,
    clicks: 480,
    ...
    linkedContentIndex: 0,
    districts: ['חיפה', 'צפון', 'דרום'],
    membersOnly: false,
  },
  {
    candidateIndex: 0,
    ...
    contentHe:
      'דוד כהן כותב על אתגרי הביטחון הלאומי לאחר ה-7 באוקטובר. קראו את ניתוחו המעמיק בנושא הגבול הצפוני.',
    dailyBudget: 480,
    cpm: 25,
    impressions: 18700,
    clicks: 1340,
  ...
  },
  {
    ...
    contentHe:
      'שרה מזרחי — תוכנית חברתית מהפכנית. קראו את המאמר המלא על דיור בר-השגה לצעירים וחינוך ציבורי איכותי.',
    dailyBudget: 300,
    cpm: 19,
    impressions: 7200,
    clicks: 390,
    ...
    approvedDaysAgo: 4,
    linkedContentType: 'article',
    linkedContentIndex: 2,
    districts: ['חיפה', 'דרום', 'צפון'],
    membersOnly: false,
  },
  ...
  // ── PENDING ─────────────────────────────────────────────────────────────
  {
    ...
    contentHe:
      'הצביעו ליוסי ברק! חזון ביטחוני מקיף להגנה על גבולות ישראל. ניסיון צבאי ומודיעיני של שלושים שנה.',
    dailyBudget: 300,
    cpm: 21,
    impressions: 0,
    clicks: 0,
  ...
  },
  {
    ...
    contentHe:
      'אל תפספסו! מפגש עם שרה מזרחי מחר בשעה 19:00 בתל אביב. הצטרפו לשידור החי באפליקציה.',
    dailyBudget: 90,
    cpm: 32,
    impressions: 0,
    clicks: 0,
  ...
  },
  {
    ...
    contentHe:
      'רוצים להשפיע? הצטרפו לקמפיין של דוד כהן — מתנדבים, תרומות ופעילות שטח. יחד ננצח בפריימריז 2026!',
    dailyBudget: 70,
    cpm: 15,
    impressions: 0,
    clicks: 0,
  ...
  // ── REJECTED ────────────────────────────────────────────────────────────
  {
    ...
    contentHe:
      'סקר חדש: אמיר שמיר עולה לראשונה למקום הראשון! ראו את הנתונים המלאים באפליקציה.',
    dailyBudget: 80,
    cpm: 30,
    impressions: 0,
    clicks: 0,
    ...
    durationDays: 7,
    rejectionReason:
      'תוכן המודעה מכיל נתוני סקר שלא אומתו. יש לספק מקור מאומת לנתוני הסקר לפני אישור.',
    rejectedDaysAgo: 18,
    districts: ['ארצי'],
    membersOnly: false,
  },
  {
    ...
    contentHe:
      'יוסי ברק — המועמד החזק ביותר בסקרים, הכי מנוסה, הכי ראוי. הצביעו לאיש הנכון.',
    dailyBudget: 450,
    cpm: 26,
    impressions: 0,
    clicks: 0,
    ...
    durationDays: 20,
    rejectionReason:
      'שימוש בניסוח עליונות ללא ביסוס עובדתי ("הכי מנוסה", "הכי ראוי"). יש לשנות את הנוסח לתיאור עובדתי.',
    rejectedDaysAgo: 13,
    districts: ['תל אביב', 'ירושלים'],
    membersOnly: false,
  },
  ...
  // ── PAUSED ──────────────────────────────────────────────────────────────
  {
    ...
    contentHe:
      'ישיבת מרכז הליכוד הערב — רינה לוי נואמת ב-20:30. בואו לשמוע את החזון לעתיד המפלגה וישראל.',
    dailyBudget: 110,
    cpm: 31,
    impressions: 3200,
    clicks: 290,
  ...
  },
  {
    ...
    contentHe:
      'שרה מזרחי — מחויבות לשינוי חברתי. הקמפיין הושהה זמנית, יחזור בקרוב.',
    dailyBudget: 220,
    cpm: 19,
    impressions: 5600,
    clicks: 230,
  ...
  // ── ENDED ───────────────────────────────────────────────────────────────
  {
    ...
    contentHe:
      'דוד כהן מכריז על מועמדותו לפריימריז הליכוד 2026! הצטרפו לתנועה — כי ישראל ראויה למנהיגות אמיתית.',
    dailyBudget: 280,
    cpm: 20,
    impressions: 18000,
    clicks: 1100,
  ...
  },
  {
    ...
    contentHe:
      'אמיר שמיר — המועמד מירושלים עם חזון לפיתוח הבירה. תחבורה, דיור וחינוך — ירושלים תהיה מופת לכל ישראל.',
    dailyBudget: 320,
    cpm: 24,
    impressions: 11500,
    clicks: 640,
...
const companyAdConfigs: CompanyAdConfig[] = [
  // ── APPROVED ──────────────────────────────────────────────────────────
  {
    ...
    contentHe:
      'פתחו חשבון עסקי בבנק הפועלים ותקבלו 3 חודשים ללא עמלות. מיועד לעסקים קטנים ובינוניים.',
  ...
  },
  {
    ...
    contentHe:
      'ירקות ופירות טריים מהשוק ישירות אליכם. משלוח חינם להזמנה ראשונה.',
  ...
  },
  {
    ...
    contentHe:
      'בנק הפועלים מציע משכנתא בריבית המיוחדת ביותר לרוכשי דירה ראשונה. ייעוץ חינם.',
  ...
  // ── PENDING ────────────────────────────────────────────────────────────
  {
    ...
    contentHe:
      'הגנו על הבית שלכם. כלל ביטוח מציע ביטוח דירה מקיף כולל תכולה וצד שלישי.',
  ...
  // ── REJECTED ───────────────────────────────────────────────────────────
  {
    ...
    durationDays: 30,
    rejectionReason:
      'המודעה עלולה להיות מטעה לגבי תשואות. יש לוודא שהתוכן עומד בדרישות רגולטוריות.',
    rejectedDaysAgo: 27,
  },
...
async function seedAdsSubscriptions() {
  ...
  try {
    ...
    if (!hasStatusColumns) {
      console.warn(
        'WARNING: status columns not found. Run migration 1711350000000-AdStatusEnhancements first.',
      );
    }
    if (!hasLinkedColumns) {
      console.warn(
        'WARNING: linkedContentType columns not found. Run migration 1711360000000-AdContentLinking first.',
      );
      console.warn(
        '         feed_sponsored ads will be seeded WITHOUT article links.\n',
      );
    }
    ...
    if (
      (parseInt(existingAds[0].count, 10) > 0 ||
        parseInt(existingSubs[0].count, 10) > 0) &&
      !forceReseed
    ) {
      console.log(
        `Already have ${existingAds[0].count} ad placements and ${existingSubs[0].count} subscriptions. Use --force to reseed.`,
      );
    ...
    if (articles.length === 0) {
      console.warn(
        'WARNING: No articles found. feed_sponsored ads will be seeded WITHOUT article links.',
      );
      console.warn(
        '         Run seed-articles first to enable content linking.\n',
      );
    } else {
    ...
    for (let i = 0; i < adConfigs.length; i++) {
      ...
      if (hasStatusColumns && hasLinkedColumns) {
        await queryRunner.query(
          ...
          [
            ...
            tsAgo(now, ad.approvedDaysAgo),
            tsAgo(now, ad.rejectedDaysAgo),
            tsAgo(now, ad.pausedDaysAgo),
            tsAgo(now, ad.endedDaysAgo),
            linkedContentType,
            linkedContentId,
            ctaUrl,
          ],
      ...
      const linkedNote = linkedContentId
        ? ` → article ${linkedContentId.slice(0, 8)}...`
        : '';
    ...
    if (appUsers.length < 5) {
      ...
      for (let i = 0; i < subscriptionConfigs.length; i++) {
        ...
        const startedAt = new Date(
          now.getTime() - sub.startedDaysAgo * 86_400_000,
        );
        const expiresAt = new Date(
          now.getTime() + sub.expiresInDays * 86_400_000,
        );
        ...
        console.log(
          `  ${i + 1}. [${sub.status.toUpperCase()}] ${sub.tier} via ${sub.provider}`,
        );
      }
    }
    ...
    if (!hasCompanyAdsTables) {
      ...
      if (parseInt(existingCompany[0].count, 10) > 0 && !forceReseed) {
        ...
        for (let i = 0; i < advertiserConfigs.length; i++) {
          ...
          console.log(
            `  ${i + 1}. ${adv.name} (${adv.isActive ? 'active' : 'inactive'}) → ${row.id.slice(0, 8)}...`,
          );
        }
        ...
        for (let i = 0; i < companyAdConfigs.length; i++) {
          ...
          const finalPlaceholders = values
            .map((_, idx) => `$${idx + 1}`)
            .join(', ');
          await queryRunner.query(
    ...
    const linkedCount = adConfigs.filter(
      (a) => a.linkedContentType === 'article',
    ).length;
    console.log(`  With article link : ${linkedCount}`);
    console.log('');
    console.log(
      `Company advertisers: ${advertiserConfigs.length} (${advertiserConfigs.filter((a) => a.isActive).length} active)`,
    );
    console.log('Company ads:');
    const companyCounts = companyAdConfigs.reduce<Record<string, number>>(
      (acc, ad) => {
        acc[ad.status] = (acc[ad.status] ?? 0) + 1;
        return acc;
      },
    ...
    console.log(
      '  candidate pays → ad links to article UUID → Flutter renders "ממומן" card',
    );
    console.log(
      '  User taps → article_detail_page → POST /ads/click → candidate billed by CPM',
    );
    console.log(
      '  Budget gate: (impressions × cpmNis) / 1000 ≥ dailyBudgetNis → ad paused for day',
    );
    console.log('═══════════════════════════════════════════════════════');
  } catch (error) {
