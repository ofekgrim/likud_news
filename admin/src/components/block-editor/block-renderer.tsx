...
function BlockContent({
  ...
  switch (block.type) {
    ...
    case 'instagram':
      return <InstagramEditor block={block} onChange={onChange} />;
    case 'facebook':
      return <FacebookEditor block={block} onChange={onChange} />;
    case 'quote':
...
function InstagramEditor({
  ...
  return (
    <div className="space-y-3">
      <div>
        <Label className="text-xs text-gray-500 mb-1 block">קישור Instagram</Label>
        <Input
          value={block.postUrl}
          onChange={(e) => onChange({ ...block, postUrl: e.target.value })}
          placeholder="https://www.instagram.com/p/... או https://www.instagram.com/reel/..."
          dir="ltr"
        />
      </div>
      {block.postUrl && (
        <div className="rounded-lg border border-gray-200 bg-gradient-to-br from-purple-50 to-pink-50 p-4 text-sm text-gray-600">
          <div className="flex items-center gap-2 mb-2">
            <div className="h-6 w-6 rounded bg-gradient-to-br from-yellow-400 via-pink-500 to-purple-600 flex items-center justify-center">
          ...
          <p className="text-xs text-gray-400 truncate" dir="ltr">{block.postUrl}</p>
        </div>
      )}
      <div>
...
function FacebookEditor({
  ...
  return (
    <div className="space-y-3">
      <div>
        <Label className="text-xs text-gray-500 mb-1 block">קישור Facebook</Label>
        <Input
          value={block.postUrl}
          onChange={(e) => onChange({ ...block, postUrl: e.target.value })}
          placeholder="https://www.facebook.com/.../videos/... או https://www.facebook.com/.../posts/..."
          dir="ltr"
        />
      </div>
      {block.postUrl && (
        <div className="rounded-lg border border-gray-200 bg-blue-50 p-4 text-sm text-gray-600">
          <div className="flex items-center gap-2 mb-2">
